...
(
    ...
    numcuota 	TINYINT			NOT NULL COMMENT 'Se debe cancelar la cuota en su totalidad sin AMOTIZACIONES',
    fechapago	DATETIME		NULL,
    monto		DECIMAL(7,2)	NOT NULL,
    penalidad	DECIMAL(7,2)	NULL DEFAULT 0 COMMENT '10% del valor de la cuota',
